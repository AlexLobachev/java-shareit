...
class ItemRequestControllerTest {
    ...
    void addRequest() throws Exception {
        ...
        when(itemRequestController.addRequest(any(), anyLong()))
                .thenReturn(responseBuilder.body(itemRequest));
    ...
    void getRequest() throws Exception {
        ...
        when(itemRequestController.getRequest(anyLong()))
                .thenReturn(responseBuilder.body(itemRequestDtos));
    ...
    void getRequestById() throws Exception {
        ...
        when(itemRequestController.getRequestById(any(), anyLong()))
                .thenReturn(responseBuilder.body(itemRequestDto));
